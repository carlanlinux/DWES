...
// Y comprobamos que el usuario se haya autentificado comprobando que en la sesión tenemos la variable usuario
if (!isset($_SESSION['usuario'])) {
    //Si no la encuentra mostramos un error y un link a la página de login para volver a empezar
...
<div id="contenedor">
    ...
    <div id="cesta">
        ...
        if (isset($_POST['vaciar'])) {
            //Borramos la variable cesta de la sesión.
            unset($_SESSION['cesta']);
        }

        // Comprobamos si se ha enviado el formulario de añadir
        if (isset($_POST['enviar'])) {
            // Creamos un array con los datos del nuevo producto que nos viene por post
        ...
        //Incializamos la variable cesta como verdadero
        $cesta_vacia = true;
        ...
        // Si no está vacía, mostrar su contenido nos recorremos el array de cesta
        else {
