...
class DB
{
    ...
    {
        $sql = "SELECT cod, nombre_corto, nombre, descripcion, familia, PVP FROM producto;";
    ...
    public static function informacionOrdenador ($codigo)
    {
        $sql = "SELECT procesador, RAM, grafica, unidadoptica, SO, otros FROM ordenador";
        $sql .= " WHERE cod='" . $codigo . "'";
        $resultado = self::ejecutaConsulta($sql);
        $ordenador = null;
