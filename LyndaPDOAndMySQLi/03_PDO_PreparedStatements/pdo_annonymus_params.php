...
if (isset($_GET['search'])) {
    try {
        ...
        //Usar el nombre del parámetro con :nombre. Lo mejor es el mismo nombre de la columna pero si se ponen ? se
        // hacen anómimos. Cuando se usan anónimos, para acceder a ellos no se puede poner nombre sino que va por orden
        // de aparición en la query.
        ...
        //Bind value para calculos y expresiones, aquí se ponen números al ser anónimos, según el orden en el que aparecen en el SQL
