        ...
        return this.each(function () {
            ...
            var sortkeys = ["shiftKey", "altKey", "ctrlKey"],
                ...
                addXmlData = function (xml, t, rcnt, more, adjust) {
                    ...
                    var i, fpos, ir = 0, v, gi = ts.p.multiselect === true ? 1 : 0, si = ts.p.subGrid === true ? 1 : 0,
                        ni = ts.p.rownumbers === true ? 1 : 0, idn, getId, f = [], F, rd = {}, xmlr, rid, rowData = [],
                        cn = (ts.p.altRows === true) ? " " + ts.p.altclass : "", cn1;
                    ...
                    if (gxml && gl) {
                        ...
                        var afterInsRow = $.isFunction(ts.p.afterInsertRow),
                            hiderow = ts.p.grouping && ts.p.groupingView.groupCollapse === true;
                        while (j < gl) {
                            xmlr = gxml[j];
                            rid = getId(xmlr, br + j);
                ...
                addJSONData = function (data, t, rcnt, more, adjust) {
                    ...
                    var ir = 0, v, i, j, f = [], F, cur, gi = ts.p.multiselect ? 1 : 0, si = ts.p.subGrid ? 1 : 0,
                        ni = ts.p.rownumbers === true ? 1 : 0, len, drows, idn, rd = {}, fpos, idr, rowData = [],
                        cn = (ts.p.altRows === true) ? " " + ts.p.altclass : "", cn1, lp;
                ...
                setColWidth = function () {
                    var initwidth = 0, brd = $.jgrid.cellWidth() ? 0 : intNum(ts.p.cellLayout, 0), vc = 0, lvc,
    ...
    $.jgrid.extend({
        ...
        setGridWidth: function (nwidth, shrink) {
            return this.each(function () {
                ...
                var $t = this, cw,
                    initwidth = 0, brd = $.jgrid.cellWidth() ? 0 : $t.p.cellLayout, lvc, vc = 0, hs = false,
        ...
        groupingRender: function (grdata, colspans) {
            return this.each(function () {
                var $t = this,
                    ...
                    cp = [], ii, len = grp.groupField.length;
