(function ($) {
     ...
     * js   : $('select[name="my-select"]').dynamicselect()
     *  or
     * var opts = { ... };
     * $('select[name="my-select"]').dynamicselect(opts);
     */
    $.fn.dynamicselect = function (opts) {
        var o = $.extend({}, $.fn.dynamicselect.defaults, opts || {});
    ...
    /**
     * jQuery.dynamicselect default options
     *
     * @type  Object
     */
