    ...
    <div id="response">
        ...
        <fieldset>
            ...
            <p>
                ...
                <input id="cname" title="Name (required, at least 2 characters" name="name" class="required"
                       minlength="2"/>
            <p>
            ...
            <p>
                ...
                <textarea cols="2" title="Your comment (required)" rows="2" id="ccomment" name="comment"
                          class="required">
      </textarea>
            </p>
            <p align="center">
