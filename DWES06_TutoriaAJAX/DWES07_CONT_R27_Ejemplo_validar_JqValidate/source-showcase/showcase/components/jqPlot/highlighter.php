...
$plot1 = new YsPlot('plot1Id', 'Data Point Highlighting');
...
$cursor->setShow(true);
$cursor->setShowVerticalLine(true);
$cursor->setShowHorizontalLine(true);

$plot1->setHighlighter($highlighter);
$plot1->setCursor($cursor);
...
<table width="90%">
    <tr>
        <td><?php echo $plot1->renderTemplate('style="margin-left:50px"'); ?></td>
    </tr>
    <tr>
        <td>
