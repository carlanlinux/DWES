 ...
 * @method YsUIAutocomplete _select Triggered when an item is selected from the menu;
 ...
 * @method YsUIAutocomplete _change Triggered when the field is blurred, if the value has changed;
 * ui.item refers to the selected item.
 *
 * @package    YepSua
