...
class YsJQueryCore extends YsJQueryUtil
{
    ...
    {
        $jquery = self::getInstance();
        if ($url_or_handler !== null) {
            $jquery->addArgument(new YsArgument($url_or_handler));
        }
        if ($data !== null) {
            $jquery->addArgument(new YsArgument($data));
        }
        if ($callback !== null) {
            $jquery->addArgument(new YsArgument($callback));
        }
    ...
    public static function get ($url = null, $data = null, $callback = null, $dataType = null)
    {
        ...
        if ($dataType !== null) {
            $jquery->addArgument(new YsArgument($dataType));
        }
    ...
    public static function param ($params, $traditional = null)
    {
        $jquery = self::getInstance();
        if ($params !== null) {
            $jquery->addArgument(new YsArgument($params));
        }
        if ($traditional !== null) {
            $jquery->addArgument(new YsArgument($traditional));
        }
    ...
    public static function stopAnimation ($clearQueue = null, $jumpToEnd = null)
    {
        $jquery = self::getInstance();
        if ($clearQueue !== null) {
            $jquery->addArgument(new YsArgument($clearQueue));
        }
        if ($clearQueue !== null) {
            $jquery->addArgument(new YsArgument($clearQueue));
        }
    ...
    public static function addClass ($className = null)
    {
        $jquery = self::getInstance();
        if ($className !== null) {
            $jquery->addArgument(new YsArgument($className));
        }
    ...
    public static function after ($content = null)
    {
        $jquery = self::getInstance();
        if ($content !== null) {
            $jquery->addArgument(new YsArgument($content));
        }
    ...
    public static function appendTo ($target = null)
    {
        $jquery = self::getInstance();
        if ($target !== null) {
            $jquery->addArgument(new YsArgument($target));
        }
    ...
    public static function attr ($attributeName = null, $value = null)
    {
        ...
        if ($attributeName !== null) {
            $jquery->attributeName($attributeName);
        }
        if ($value !== null) {
            $jquery->value($value);
        }
    ...
    {
        $jquery = self::getInstance();
        if ($withDataAndEvents !== null) {
            $jquery->addArgument(new YsArgument($withDataAndEvents));
        }
        if ($deepWithDataAndEvents !== null) {
            $jquery->addArgument(new YsArgument($deepWithDataAndEvents));
        }
    ...
    public static function css ($propertyName = null, $value = null)
    {
        ...
        if ($propertyName !== null) {
            $jquery->attributeName($propertyName);
        }
        if ($value !== null) {
            $jquery->value($value);
        }
    ...
    public static function outerHeight ($includeMargin = null)
    {
        ...
        if ($includeMargin !== null) {
            $jquery->includeMargin($includeMargin);
        }
    ...
    public static function bind ($eventType = null, $eventData = null, $handler = null)
    {
        ...
        if ($eventData !== null) {
            $jquery->eventData($eventData);
        }
        if ($eventType !== null) {
            $jquery->eventType($eventType);
        }
    ...
    public static function trigger ($eventType = null, $extraParameters = null)
    {
        ...
        if ($extraParameters !== null) {
            $jquery->properties($extraParameters);
        }
    ...
    public static function then ($doneCallbacks = null, $failCallbacks = null)
    {
        ...
        if ($doneCallbacks !== null) {
            $jquery->doneCallbacks($doneCallbacks);
        }
        if ($failCallbacks !== null) {
            $jquery->failCallbacks($failCallbacks);
        }
    ...
    public static function on ($events = null, $selector = null, $data = null, $handler = null)
    {
        $jquery = self::getInstance();
        if ($events !== null) {
            $jquery->addArgument(new YsArgument($events));
        }
        if ($selector !== null) {
            $jquery->addArgument(new YsArgument($selector));
        }
        if ($data !== null) {
            $jquery->addArgument(new YsArgument($data));
        }
        if ($handler !== null) {
            $jquery->addArgument(new YsArgument($handler));
        }
    ...
    public static function isNumeric ($value = null)
    {
        $jquery = self::getInstance();
        if ($value !== null) {
            $jquery->addArgument(new YsArgument($value));
        }
    ...
    {
        if (isset(self::$selector)) {
            $this->setSelector(self::$selector);
        }
