                    ...
                    <li><a href="#" class="super"><span>-</span> <?php echo ucfirst($file) ?></a>
                        ...
                        <ul class="children">
                            ...
                            <ul class="children" style="display:none">
                                <?php endif; ?>
                                <li>
                                    <a href="<?php echo sprintf('index.php?section=%s&module=%s&method=%s', $path, $file, $method) ?>"
                                       title="View all posts filed under Ajax"><?php echo ucfirst(str_replace('_', ' ', $method)) ?></a>
                                </li>
                            </ul>
                            <?php endif; ?>
                            <?php endwhile; ?>
        ...
        <ul class="xoxo">
            <li>
                <ul>
                    <?php while ($file = readdir($dir_handle)): ?>
                    <?php if (!is_dir($file) && !in_array($file, $noList)): ?>
                    <li><a href="#" class="super" title="View all posts filed under <?php echo ucfirst($file) ?>"><span>-</span> <?php echo ucfirst($file) ?>
                        </a>
                        <?php $child_dir_handle = @opendir($path . DIRECTORY_SEPARATOR . $file) or die("Unable to open '" . $path . DIRECTORY_SEPARATOR . $file . "' source dir."); ?>
                        <?php while ($childrenFile = readdir($child_dir_handle)): ?>
                        <?php if (!is_dir($childrenFile) && !in_array($childrenFile, $noList)): ?>
                        ...
                        <ul class="children">
                            ...
                            <ul class="children" style="display:none">
                                ...
                                <li>
                                    <a href="<?php echo sprintf('index.php?section=%s&module=%s&method=%s', $path, $file, $method) ?>"
                                       title="Show demo and source code">::<?php echo $method ?>()</a></li>
                            </ul>
                            <?php endif; ?>
                            <?php endwhile; ?>
                            </li>
        ...
        <ul class="xoxo">
            <li>
                <ul>
                    <?php while ($file = readdir($dir_handle)): ?>
                    <?php if (!is_dir($file) && !in_array($file, $noList)): ?>
                    <li><a href="#" class="super"
                           title="View all posts filed under jQueryUI <?php echo ucfirst($file) ?>"><span>-</span> <?php echo ucfirst($file) ?>
                        </a>
                        <?php $child_dir_handle = @opendir($path . DIRECTORY_SEPARATOR . $file) or die("Unable to open '" . $path . DIRECTORY_SEPARATOR . $file . "' source dir."); ?>
                        <?php while ($childrenFile = readdir($child_dir_handle)): ?>
                        <?php if (!is_dir($childrenFile) && !in_array($childrenFile, $noList)): ?>
                        ...
                        <ul class="children">
                            ...
                            <ul class="children" style="display:none">
                                ...
                                <li>
                                    <a href="<?php echo sprintf('index.php?section=%s&module=%s&method=%s', $path, $file, $method) ?>"
                                       title="Show demo and source code"><?php echo str_ireplace('__', ' ', ucfirst($method)) ?></a>
                                </li>
                            </ul>
                            <?php endif; ?>
                            <?php endwhile; ?>
        ...
        <ul class="xoxo">
            <li>
                <ul>
                    ...
                    <?php if (!is_dir($file) && !in_array($file, $noList)): ?>
                    <li><a href="#" class="super"
                           title="View all posts filed under <?php echo ucfirst($file) ?> Plugin"><span>-</span> <?php echo ucfirst($file) ?>
                        </a>
                        <?php $child_dir_handle = @opendir($path . DIRECTORY_SEPARATOR . $file) or die("Unable to open '" . $path . DIRECTORY_SEPARATOR . $file . "' source dir."); ?>
                        <?php while ($childrenFile = readdir($child_dir_handle)): ?>
                        <?php if (!is_dir($childrenFile) && !in_array($childrenFile, $noList)): ?>
        ...
        <ul class="xoxo">
            <li>
                <ul>
                    ...
                    <?php if (!is_dir($file) && !in_array($file, $noList)): ?>
                    <li><a href="#" class="super"
                           title="View all posts filed under <?php echo ucfirst($file) ?> Component"><span>-</span> <?php echo ucfirst($file) ?>
                        </a>
                        <?php $child_dir_handle = @opendir($path . DIRECTORY_SEPARATOR . $file) or die("Unable to open '" . $path . DIRECTORY_SEPARATOR . $file . "' source dir."); ?>
                        <?php while ($childrenFile = readdir($child_dir_handle)): ?>
                        <?php if (!is_dir($childrenFile) && !in_array($childrenFile, $noList)): ?>
