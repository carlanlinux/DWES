<div id="jq-header">
    ...
    <a id="jq-siteLogo" href="http://jquery4php.sourceforge.net/" title="jQuery4PHP Home"><img
                src="images/logo_jquery4php_285x60.jpg" alt="jQuery4PHP: Write Less, Do More." width="285" height="60"></a>
...
-->
    <form id="jq-primarySearchForm" action="http://api.jquery.com" method="get" autocomplete="off">
        <div>
            ...
            <input value="" accesskey="f" title="Search jQuery" name="s" id="jq-primarySearch" class="keynav"
                   type="text">
