<ul>
    <li class="jq-download jq-first"><a
                href="http://sourceforge.net/projects/jquery4php/files/"><span>Download</span></a></li>
    <li class="jq-documentation"><a
                href="http://jquery4php.sourceforge.net/documentation.php"><span>Documentation</span></a></li>
    <li class="jq-tutorials"><a href="http://jquery4php.sourceforge.net/tutorials.php"><span>Tutorials</span></a></li>
    <li class="jq-bugTracker"><a href="http://sourceforge.net/tracker/?group_id=308293"><span>Bug Tracker</span></a>
    </li>
