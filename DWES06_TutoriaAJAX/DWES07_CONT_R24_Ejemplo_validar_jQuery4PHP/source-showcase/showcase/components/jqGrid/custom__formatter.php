...
$idGridField->setFormatter(YsArgument::likeVar('formatRating'));
$idGridField->setUnformat(YsArgument::likeVar('unformatRating'));
...
<script type="text/javascript" language="javascript">
    ...
    function formatRating(cellValue, options, rowObject) {
        var color = (parseInt(cellValue) > 5) ? "green" : "red";
        var cellHtml = "<b><span style='color:" + color + "' originalValue='" +
            cellValue + "'>" + cellValue + "</span></b>";
        return cellHtml;
    }
