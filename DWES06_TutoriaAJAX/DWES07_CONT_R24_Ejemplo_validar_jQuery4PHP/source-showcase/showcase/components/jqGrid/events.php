...
$grid->setOnPaging(new YsJsFunction('alert("On paging event")'));
$grid->setBeforeSelectRow(new YsJsFunction('alert("Before select a row"); return true'));
$grid->setOnSelectAll(new YsJsFunction('alert("All was selected")'));
$grid->setOnSelectRow(new YsJsFunction('alert("Row Selected")'));
