...
<div id="login">
    <form method="post" action="" class="pf-form pform_custom">
        ...
        <input type="button" id="btnSubmit" value="Submit" name="submit"
               class="pf-button ui-state-default ui-corner-all ui-priority-primary">
        <input type="reset" value="Reset" name="reset"
               class="pf-button ui-state-default ui-corner-all ui-priority-secondary">
    </form>
</div>
