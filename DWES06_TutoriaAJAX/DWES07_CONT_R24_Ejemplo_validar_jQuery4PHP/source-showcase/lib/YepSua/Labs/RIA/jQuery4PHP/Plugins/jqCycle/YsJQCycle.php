 ...
 * @method YsJQCycle _fastOnEvent($value) force fast transitions when triggered manually (via pager or prev/next);
 * value == time in ms
 ...
 * @method YsJQCycle _randomizeEffects($value) valid when multiple effects are used;
 ...
 * @method YsJQCycle _shuffle($value) coords for shuffle animation, ex: {
 * top:15, left: 200
 * }
