 ...
 * @method YsBlockUI _fadeIn FadeIn time in millis;
 * set to 0 to disable fadeIn on block
 * @method YsBlockUI _fadeOut FadeOut time in millis;
 * set to 0 to disable fadeOut on unblock
 * @method YsBlockUI _timeout Time in millis to wait before auto-unblocking;
