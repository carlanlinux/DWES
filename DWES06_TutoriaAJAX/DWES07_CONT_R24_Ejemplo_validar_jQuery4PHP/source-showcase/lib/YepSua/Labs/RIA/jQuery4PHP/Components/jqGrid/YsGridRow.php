...
class YsGridRow
{
    ...
    {
        if (isset($this->levelField)) {
            $this->newCell($this->levelField);
        }
        if (isset($this->leftField)) {
            $this->newCell($this->leftField);
        }
        if (isset($this->rightField)) {
            $this->newCell($this->rightField);
        }
        if (isset($this->isLeaf)) {
            $this->newCell($this->isLeaf);
        }
        if (isset($this->isExpanded)) {
            $this->newCell($this->isExpanded);
        }
    }
